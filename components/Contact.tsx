        ...
        <div className='w-full h-full border-4 border-primary rounded-lg bg-white p-4'>
          ...
          <div className='mt-8 grid grid-cols-3 gap-4'>
            <iframe
              ...
              width='100%'
              className='rounded-lg col-span-3 lg:col-span-2 h-[calc(100vh-25rem)] lg:h-[calc(100vh-10rem)]'
              style={{ border: '0' }}
              allowFullScreen
              loading='lazy'
              referrerPolicy='no-referrer-when-downgrade'
            ></iframe>
            <div className='w-full bg-[#ffe7e9] rounded-lg p-4 col-span-3 lg:col-span-1'>
              <div>
