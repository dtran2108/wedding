...
export default function OurJourneyGrid() {
  return (
    <motion.div
      ...
      className={cn(
        SECTION_STYLE,
        'bg-red text-white p-2 md:p-4 lg:p-6 cursor-pointer flex flex-col overflow-hidden'
      )}
    ...
    >
      ...
      <div className='flex flex-1 flex-col justify-between space-y-2 md:space-y-4 relative text-sm lg:text-lg my-4'>
